...
class BatchThemeExportDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        self.list_themes.setSelectionMode(QListWidget.ExtendedSelection)
        ...
        self.btn_check_selected.clicked.connect(self._check_selected)
        self.btn_uncheck_selected = QPushButton("Uncheck Selected")
        self.btn_uncheck_selected.clicked.connect(self._uncheck_selected)
        ...
        theme_btn_layout.addWidget(self.btn_check_selected)
        theme_btn_layout.addWidget(self.btn_uncheck_selected)
    ...
    def _check_selected(self):
        for item in self.list_themes.selectedItems():
            item.setCheckState(Qt.Checked)
...
def show_batch_theme_export_dialog():
